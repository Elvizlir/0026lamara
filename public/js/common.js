...
function eventHandler() {
	...
	function heightses() {
		...
		$(window).scroll(function () {
			if ($(window).scrollTop() > topH) {// $('.top-nav  ').addClass('fixed');
			} else {// $('.top-nav  ').removeClass('fixed');
				}
		}); // конец добавил
	...
	$('.s-reviews__slider--js').slick(_objectSpread({}, defaultSlide, {
		slidesToShow: 1,
		slidesToScroll: 1,
		dots: true,
	...
	$('.s-cases__slider-title--js').slick(_objectSpread({}, defaultSlide, {
		slidesToShow: 1,
		slidesToScroll: 1,
		dots: false,
		arrows: false,
	...
	$('.s-cases__slider--js').slick(_objectSpread({}, defaultSlide, {
		slidesToShow: 1,
		slidesToScroll: 1,
		dots: true,
